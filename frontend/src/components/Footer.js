...
const Footer = () => {
  return <Segment style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginTop: 'auto' }}>
    ...
    <Button secondary color='black' as='a' target='_blank' rel='noopener noreferrer' href='https://www.github.com/alexander-ding/lost-in-translation' style={{ marginLeft: 'auto', minWidth: 108 }}>
